...
document.addEventListener('DOMContentLoaded', () => {
    const openPopupBtn = document.querySelector('.open-popup-btn-stepbystep-kids');
    const closePopupBtn = document.querySelector('.close-popup-btn-stepbystep-kids');
    const popupContainer = document.querySelector('.popup-container-stepbystep-kids');
...
document.addEventListener('DOMContentLoaded', () => {
    const openPopupBtn = document.querySelector('.open-popup-btn-stepbystep-fly');
    const closePopupBtn = document.querySelector('.close-popup-btn-stepbystep-fly');
    const popupContainer = document.querySelector('.popup-container-stepbystep-fly');
...
document.addEventListener('DOMContentLoaded', () => {
    const openPopupBtn = document.querySelector('.open-popup-btn-stepbystep-sw');
    const closePopupBtn = document.querySelector('.close-popup-btn-stepbystep-sw');
    const popupContainer = document.querySelector('.popup-container-stepbystep-sw');
